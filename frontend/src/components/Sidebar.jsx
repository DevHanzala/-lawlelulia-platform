    ...
    return (
        <>
            ...
            <div
                ...
                fixed md:top-0 top-10 left-0 z-50 transform transition-transform duration-300 ease-in-out
                flex flex-col
                ${sidebarOpen ? "translate-x-0" : "-translate-x-full"}
                ${hideOnDesktop
                    ? "md:hidden w-full sm:w-72"
                    : "md:sticky md:top-0 md:translate-x-0 md:flex md:h-screen md:w-56"
                }
                w-full sm:w-72`}
                style={{ height: "100dvh" }}
            >
                {/* Brand */}
                <div className="flex flex-col p-2 border-b border-gray-200 shrink-0">
                    <div className="flex justify-between items-center">
                        <Link to="/" onClick={handleClose} className="flex items-center gap-2">
                            <div className="w-7 h-7 rounded-full bg-[#0A0F1C] flex items-center justify-center text-white font-bold text-sm">C</div>
