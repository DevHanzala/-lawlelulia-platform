...
const ClientDashboard = () => {
    ...
    const user = JSON.parse(localStorage.getItem("cocolaw_user") || "{}");

    useEffect(() => { fetchAllUserAppointments(); getCases(); }, []);
        ...
        <div className="p-4 md:p-6">
            ...
            <div className="flex flex-col lg:flex-row gap-4">
                ...
                <div data-reveal className="w-full lg:w-1/2 bg-white rounded-2xl border border-gray-100 shadow-sm p-4">
                    ...
                    {apptLoading ? (
                        <div className="flex justify-center py-8"><div className="w-5 h-5 border-4 border-[#0A0F1C] border-t-transparent rounded-full animate-spin" /></div>
                    ) : future.length === 0 ? (
