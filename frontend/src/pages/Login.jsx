            ...
            <div className="flex-1 w-full flex flex-col md:flex-row md:justify-evenly items-center p-8 gap-8">
                ...
                <div className="w-full max-w-sm p-4">
                    ...
                    <input
                        type="email"
                        placeholder="Email"
                        className="w-full border border-gray-300 p-2 rounded-md text-sm mt-6 outline-none focus:ring-2 focus:ring-blue-800"
                    />
                    <input
                        type="password"
                        placeholder="Password"
                        className="w-full border border-gray-300 p-2 rounded-md text-sm mt-4 outline-none focus:ring-2 focus:ring-blue-800"
                    />
                    ...
                    <p className="mt-4 text-sm">
                        ...
                        <Link to="/signup" className="text-blue-800 hover:underline">Register here</Link>
                    </p>
                </div>
