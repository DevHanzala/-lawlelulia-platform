...
const caseTypes = [
    {
        ...
        stat: "~72%",
        statLabel: "of family court filings involve at least one self-represented party",
    },
    {
        icon: "🏢",
        ...
        stat: "~90%",
        statLabel: "of tenants in eviction proceedings appear without an attorney",
    },
    {
        icon: "💼",
        ...
        stat: "58%",
        statLabel: "of employment discrimination claims are filed pro se",
    },
    {
        icon: "💳",
        title: "Consumer & Debt",
        ...
        stat: "$0",
        statLabel: "filing fee threshold for small claims in many states",
    },
    {
        icon: "🏛️",
        title: "Civil Rights",
        ...
        stat: "High",
        statLabel: "dismissal rate for pro se § 1983 complaints due to pleading errors",
    },
    {
        icon: "📜",
        ...
        stat: "~65%",
        statLabel: "of probate matters qualify for simplified small estate procedures",
    },
];
    ...
    return (
        <div className="bg-gray-50 min-h-screen overflow-x-hidden">
            ...
            <div className="bg-[#0A0F1C] text-white text-center py-16 px-6 relative overflow-hidden" style={{ borderBottom: "3px solid #1e2740" }}>
                <div className="absolute right-8 bottom-0 w-36 h-36 text-white opacity-20 hidden lg:block pointer-events-none">
                    <GavelSVG />
                </div>
            ...
            <section className="px-6 md:px-16 py-14" style={{ borderBottom: "1px solid #e5e7eb" }}>
                <div className="max-w-5xl mx-auto">
                    ...
                    <p className="text-gray-500 text-sm text-center max-w-xl mx-auto mb-10" data-reveal>Each service maps directly to a documented challenge pro se litigants face  nothing is generic.</p>
                    <div className="grid md:grid-cols-2 gap-6">
                        {mainServices.map((service, i) => (
                            <div key={i} data-reveal className="bg-white rounded-xl shadow-sm border-t-2 border-[#0A0F1C] p-6 hover:shadow-md transition-all duration-300 group">
            ...
            <section className="px-6 md:px-16 py-14 bg-white" style={{ borderBottom: "1px solid #e5e7eb" }}>
                <div className="max-w-5xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
                        {caseTypes.map((c, i) => (
                            <div key={i} data-reveal className="bg-gray-50 border border-gray-200 rounded-xl p-5 hover:border-[#0A0F1C] hover:shadow-md transition-all duration-300 group flex flex-col">
                                {/* Header */}
                                ...
                                <div className="flex flex-wrap gap-1.5 mb-3">
                                    {c.tags.map((tag, ti) => (
                                        <span key={ti} className="text-xs bg-white border border-gray-200 text-gray-500 px-2 py-0.5 rounded-full">
                                            {tag}
                                        </span>
                                    ))}
                                </div>
                                ...
                                {/* Stat callout */}
                                <div className="border-t border-gray-200 pt-3 mt-auto flex items-start gap-2">
                    ...
                    <p className="text-center text-xs text-gray-400 mt-8 italic" data-reveal>
                        Don't see your case type? CoCoLaw.ai also supports immigration, bankruptcy, civil appeals, and more. Start a conversation to find out.
                    </p>
                </div>
            </section>
            ...
            <section className="px-6 md:px-16 py-14 bg-gray-50" style={{ borderBottom: "1px solid #e5e7eb" }}>
                <div className="max-w-5xl mx-auto">
                    ...
                    <p className="text-gray-500 text-sm text-center mb-10" data-reveal>Addressing the practical limitations and systemic disadvantages faced by pro se litigants every day.</p>
                    <div className="grid md:grid-cols-3 gap-6">
                        {resourcePoints.map((item, i) => (
                            <div key={i} data-reveal className="text-center p-6 bg-white border border-gray-200 rounded-xl hover:border-[#0A0F1C] hover:shadow-md transition-all duration-300">
                                <div className="w-14 h-14 bg-gray-50 border border-gray-200 rounded-full mx-auto mb-4 flex items-center justify-center text-2xl">
                                    {item.icon}
                                </div>
            ...
            <section className="px-6 md:px-16 py-14 bg-[#0A0F1C] text-white relative overflow-hidden" style={{ borderTop: "3px solid #1e2740", borderBottom: "3px solid #1e2740" }}>
                <div className="max-w-5xl mx-auto relative z-10">
                    <h2 className="text-2xl font-bold text-center mb-2" data-reveal>How It Works</h2>
                    <p className="text-gray-400 text-sm text-center mb-12" data-reveal>Four steps from your first question to your final filing.</p>
                    <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-0">
                        {[
                            ...
                            <div key={i} data-reveal className={`p-5 ${i < 3 ? "md:border-r border-gray-700" : ""} border-b md:border-b-0 border-gray-800`}>
            ...
            {/* ── CTA ── */}
            <section className="text-center py-16 px-6 bg-white" style={{ borderTop: "1px solid #e5e7eb" }}>
